...
package com.lzf.myapplication.util;
...
public class UpnpUtil {
    ...
    public static UDN uniqueSystemIdentifier(String salt) {
        ...
        Log.d(TAG, "host:" + MyApplication.getHostName() + " ip:" + MyApplication.getHostAddress());
        if (null != MyApplication.getHostName()
                && null != MyApplication.getHostAddress()) {
            systemSalt.append(MyApplication.getHostName()).append(
                    MyApplication.getHostAddress());
        }
