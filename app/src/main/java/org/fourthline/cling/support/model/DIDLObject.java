...
public abstract class DIDLObject {
    ...
    static public abstract class Property<V> {
        ...
        static public class DC {
            ...
            static public class RELATION extends Property<java.net.URI> implements NAMESPACE {
                public RELATION() {
                }

                public RELATION(java.net.URI value) {
                    super(value, null);
                }
            }
        ...
        static public abstract class SEC {
            ...
            static public class CAPTIONINFOEX extends Property<java.net.URI> implements NAMESPACE {
                public CAPTIONINFOEX() {
                    this(null);
                }
                
                public CAPTIONINFOEX(java.net.URI value) {
                    super(value, "CaptionInfoEx");
                }

                public CAPTIONINFOEX(java.net.URI value, List<Property<DIDLAttribute>> attributes) {
                    super(value, "CaptionInfoEx", attributes);
                }
            }
            
            static public class CAPTIONINFO extends Property<java.net.URI> implements NAMESPACE {
                public CAPTIONINFO() {
                    this(null);
                }
                
                public CAPTIONINFO(java.net.URI value) {
                    super(value, "CaptionInfo");
                }

                public CAPTIONINFO(java.net.URI value, List<Property<DIDLAttribute>> attributes) {
        ...
        static public abstract class UPNP {
            ...
            static public class ALBUM_ART_URI extends Property<java.net.URI> implements NAMESPACE {
                public ALBUM_ART_URI() {
                    this(null);
                }

                public ALBUM_ART_URI(java.net.URI value) {
                    super(value, "albumArtURI");
                }

                public ALBUM_ART_URI(java.net.URI value, List<Property<DIDLAttribute>> attributes) {
                    super(value, "albumArtURI", attributes);
                }
            }

            static public class ARTIST_DISCO_URI extends Property<java.net.URI> implements NAMESPACE {
                public ARTIST_DISCO_URI() {
                    this(null);
                }

                public ARTIST_DISCO_URI(java.net.URI value) {
                    super(value, "artistDiscographyURI");
                }
            }

            static public class LYRICS_URI extends Property<java.net.URI> implements NAMESPACE {
                public LYRICS_URI() {
                    this(null);
                }

                public LYRICS_URI(java.net.URI value) {
            ...
            static public class ICON extends Property<java.net.URI> implements NAMESPACE {
                public ICON() {
                }

                public ICON(java.net.URI value) {
                    super(value, null);
                }
            }
